    ...
    private var metricsSection: some View {
        VStack(alignment: .leading, spacing: AppDesign.Spacing.medium) {
            ...
            LazyVGrid(columns: [
                ...
                MetricTile(label: "Moving (est.)", value: model.movingTimeText, icon: "figure.run", color: AppDesign.MetricColor.duration)
                ...
                MetricTile(label: "Moving Pace (est.)", value: model.movingPaceText, icon: "figure.run", color: AppDesign.MetricColor.pace)
