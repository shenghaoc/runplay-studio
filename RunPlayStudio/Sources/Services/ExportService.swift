...
struct ExportService {
    ...
    func exportWorkoutSummaryJSON(workout: RunWorkout, segments: [SegmentHighlight]) throws -> ExportResult {
    ...
    func exportSplitsCSV(workout: RunWorkout) throws -> ExportResult {
    ...
    func exportSegmentsCSV(segments: [SegmentHighlight]) throws -> ExportResult {
    ...
    func exportCombinedCSV(workout: RunWorkout, segments: [SegmentHighlight]) throws -> ExportResult {
    ...
    func generateSplitsCSV(workout: RunWorkout) -> String {
        var lines: [String] = []
    ...
    func generateSegmentsCSV(segments: [SegmentHighlight]) -> String {
        var lines: [String] = []
    ...
    func generateCombinedCSV(workout: RunWorkout, segments: [SegmentHighlight]) -> String {
        var sections: [String] = []
...
enum ExportFilenameBuilder {
    static func filename(for workout: RunWorkout?, format: ExportFormat) -> String {
        let baseName: String
