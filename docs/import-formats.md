...
- Malformed optional FIT/TCX lap messages do not invalidate an otherwise usable route. They are skipped with aggregated diagnostics; decoded lap metrics are revalidated as finite, non-negative, and within the shared HR/cadence ranges.
