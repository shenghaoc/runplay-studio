...
4. **Focused depth, not shallow breadth.** Deep replay, rich comparison, precise segment detection. No feature-creep: if it doesn't help a runner understand their workout better, it doesn't ship.
