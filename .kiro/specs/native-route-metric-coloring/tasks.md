# Tasks: Native Route Metric Coloring

- [x] Core models, policy, weighted statistics, profile builder
- [x] Refactor RouteColorMetrics / RouteColoringService to canonical builder
- [x] Platform line style, palette, metric line builder
