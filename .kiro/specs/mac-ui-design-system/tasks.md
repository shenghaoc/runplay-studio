...
- [x] Add keyboard paths, focus participation, Option-Space play or pause,
  Option-arrow frame stepping, accessible chart seeking that commits on submit
  or focus loss, destructive confirmation, and Reduce Motion handling.
...
- [x] Verify the exact-head GitHub checks, including resolved post-review
  keyboard and seek-field follow-up threads.
